...
export const Quality = z.enum(["calculated", "estimated"]);
export type Quality = z.infer<typeof Quality>;

export const DatevalType = z.enum(["about", "before"]);
export type DatevalType = z.infer<typeof DatevalType>;
...
export const Role = z.enum(["Bride", "Family", "Groom", "Primary"]);
export type Role = z.infer<typeof Role>;

export const RelType = z.enum([
  "Civil Union",
  "Married",
  "Unknown",
  "Unmarried",
...
export const Gender = z.enum(["F", "M", "U"]);
export type Gender = z.infer<typeof Gender>;

export const Derivation = z.enum(["Given", "Location", "Taken", "Unknown"]);
export type Derivation = z.infer<typeof Derivation>;

export const NameType = z.enum([
  "Also Known As",
  "Birth Name",
  "Married Name",
  "Unknown",
]);
export type NameType = z.infer<typeof NameType>;
...
export const EventDatevalSchema = z.object({
  ...
  type: z.union([DatevalType, z.null()]).optional(),
  quality: z.union([Quality, z.null()]).optional(),
});
