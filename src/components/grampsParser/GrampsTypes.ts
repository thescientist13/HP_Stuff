...
export type EventType = "Birth" | "Death" | "Marriage" | "Hogwarts Sorting" | "Education" | "Engagement" | "Elected" | "Retirement";
...
export type NameType = "Birth Name" | "Married Name" | "Also Known As" | "Unknown";
...
const typeMap: any = {
  ...
  "Citation": o([
    ...
    { json: "id", js: "id", typ: "" },
    { json: "dateval", js: "dateval", typ: u(undefined, r("CitationDateval")) },
    { json: "noteref", js: "noteref", typ: u(undefined, r("Noteref")) },
  ], false),
  "CitationDateval": o([
    { json: "val", js: "val", typ: u(Date, 0) },
  ], false),
  "Noteref": o([
  ...
  "Event": o([
    ...
    { json: "citationref", js: "citationref", typ: u(undefined, u(a(r("Noteref")), r("Noteref"))) },
    { json: "handle", js: "handle", typ: "" },
    { json: "change", js: "change", typ: 0 },
    { json: "id", js: "id", typ: "" },
    { json: "noteref", js: "noteref", typ: u(undefined, r("Noteref")) },
    ...
    { json: "datespan", js: "datespan", typ: u(undefined, r("DaterangeClass")) },
    { json: "daterange", js: "daterange", typ: u(undefined, r("DaterangeClass")) },
  ...
  "Families": o([
    { json: "family", js: "family", typ: a(r("Family")) },
  ], false),
  "Family": o([
  ...
  "ChildrefElement": o([
    { json: "hlink", js: "hlink", typ: "" },
    { json: "citationref", js: "citationref", typ: u(undefined, r("Noteref")) },
  ...
  "People": o([
    { json: "person", js: "person", typ: a(r("Person")) },
  ], false),
  "Person": o([
    { json: "gender", js: "gender", typ: r("Gender") },
    { json: "name", js: "name", typ: u(a(r("NameElement")), r("NameElement")) },
    { json: "eventref", js: "eventref", typ: u(undefined, u(a(r("EventrefElement")), r("EventrefElement"))) },
    { json: "childof", js: "childof", typ: u(undefined, u(a(r("Noteref")), r("Noteref"))) },
    { json: "parentin", js: "parentin", typ: u(undefined, u(a(r("Noteref")), r("Noteref"))) },
    { json: "tagref", js: "tagref", typ: u(undefined, u(a(r("Noteref")), r("Noteref"))) },
    { json: "handle", js: "handle", typ: "" },
    { json: "change", js: "change", typ: 0 },
    { json: "id", js: "id", typ: "" },
    { json: "noteref", js: "noteref", typ: u(undefined, r("Noteref")) },
  ...
  "Source": o([
    ...
    { json: "change", js: "change", typ: 0 },
    { json: "id", js: "id", typ: "" },
    { json: "reporef", js: "reporef", typ: u(undefined, u(a(r("ReporefElement")), r("ReporefElement"))) },
    { json: "noteref", js: "noteref", typ: u(undefined, r("Noteref")) },
  ], false),
  "ReporefElement": o([
    { json: "hlink", js: "hlink", typ: "" },
