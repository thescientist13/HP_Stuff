...
<dl>
    ...
    <dd>Comments: In general the idea that [Ron] and [Hermione] are part of some plot
        ...
        provides a reasonable explanation for the scenario.</dd>

    <dt>_[The Unknown Power](https://crys.fanficauthors.net/The_Unknown_Power/)_</dt>
    <dd>Author: Crys</dd>
    <dd>Published: 2005-09-16. Updated: 2005-09-20.</dd>
    <dd>Comments: In this story, [Harry] does not trust [Dumbledore] after the
    ...
    <dd>Comments: This bond story is one of the longer ones.  I really like the
    ...
    <dd>Comments: This story ignores the concept of [Horcruxes], and all the
    ...
    <dt>_[Hope for the Best, Plan for the Worst](https://siye.co.uk/viewstory.php?sid=130020)_</dt>
    <dd>Author: Just Horsing Around</dd>
    <dd>Published: 2015-10-09. Updated: 2015-10-19.</dd>
    <dd>Comments: This story pre-dates [Ginny]'s confidence around [Harry] to
        ...
        unfortunate that the author did not develop this concept further.</dd>
    ...
    <dd>Comments: This is one of the stories where [Harry] sends his memories back
        in time.  Unlike most, this [Harry] decides that he is best off using his
        memories to *not be noticed at all.*  A truly interesting twist.</dd>
    ...
    <dd>Comments: This really focuses more on Ron and [Hermione] than it does on
    ...
    <dd>Comments: Featuring a Manipulative but not evil [Dumbledore], and a
        redeemable [Snape], this one is a super-powered [Harry] story with a bit of a
        twist.  There is a bit of a bond in this one, but it is very under-stated.</dd>

    <dt>_[A Romance In Reverse](https://www.fanfiction.net/s/12413357)_</dt>
    <dd>Author: DukeBrymin</dd>
    <dd>Published: 2017-03-20</dd>
    <dd>Comments: I have always wished that the author had chosen to expand this
        ...
        it all flows from there.</dd>

    <dt>_[Realizations]_</dt>
    <dd>Author: sbmcneil</dd>
    <dd>Published: 2012-02-26. Updated: 2017-07-15.</dd>
    <dd>Comments: Despite its unfinished state, this is one of my favourite after
        ...
        This story gets all these things right.</dd>
    ...
    <dd>Comments: In many ways this is a shorter version of _[Realizations]_.
    ...
    <dd>Comment: This one shot is endearing in the super powered [Harry] genre. [Harry] and [Ginny] just *fit*.</dd>
    ...
    <dd>Comment: Few stories deal with the possibility that [Harry] might get
    ...
    <dd>Comment: This one is slightly more optimistic about the ability to use
        magic to help [Harry] recover.  Memories are used as a form of therapy
        to assist in recovery from catastrophic brain injury.</dd>
    ...
    <dd>Comment: This is an [X-Men] crossover story, and while
        I do not think the author *quite* pulled off the bit about despair as a
        trigger for mutant powers, it remains a story I keep coming back to.</dd>
    ...
    <dd>Comments: This short and entirely alternate universe work is amusing.
    ...
    <dd>Comments: I have always wished this were the first of a series.  In this,
        ...
        story, trauma causes magical children to mature faster in odd ways.</dd>
    ...
    <dd>Comments: I think what I like about this one is that I can see where it
        ...
        entirely realistic, as is [Harry]'s response to it.</dd>
    ...
    <dd>Comments: I do not often like either redeamed [Snape] nor books with
        ...
        he allows [Riddle] to kill him.</dd>
    <dt>
    ...
    <dd>
        ...
        stronger [Harry]/[Ginny] interaction.  The amlet induced bond is an
    ...
    <dd>
        ...
        * _[Fireworks](https://www.fanfiction.net/s/7537726) by 
          [ashfordpines](https://www.fanfiction.net/u/2919392/ashfordpines)
        * _[The Forgotten Summer Birthday](https://www.siye.co.uk/siye/viewstory.php?sid=130062) by [CharmHazel](https://www.siye.co.uk/siye/viewuser.php?uid=209861)
    </dd>
    <dd>
