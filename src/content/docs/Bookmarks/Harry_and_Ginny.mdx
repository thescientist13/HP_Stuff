...
<dl>
    ...
    <dt>[The Hidden Hero]</dt>
    <dd>
        Author: [EveBB](https://www.fanfiction.net/u/472737/EveBB)
    </dd>
    <dd>
        Published: 2008-01-06. Updated> 2008-01-28.
    </dd>
    <dd>
        Comments:  One of the interesting things about this story is that it does not shy away from the emotional damage that both the canonical books and many fan fiction authors do.  I cannot count the number of works where [Harry] comes into contact with something tramatic and just sort of shrugs it off.  It is even worse in the occasional fan fiction that will explore the possibilities of the mental link the soul shard that attached itself to him presents.  This work flies in the face of that.  [Harry] is damaged, but still recognizable.  Not quite as brash and reckless, because he is not as untouchable, but more real for it.  Unfortunately featuring [Snape] and [Draco] in their best lights. 
    </dd>
