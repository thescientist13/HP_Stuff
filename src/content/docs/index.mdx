...
<CardGrid stagger>
  <Card title="Encyclopedic Reference" icon="pencil">
    My [notes and speculation][notes] about the series.
  </Card>
  <Card title="Bookmarks" icon="add-document">
      [Bookmarks] for works I find particularly memorable, worth re-reading,
